...
export function HomeFeaturedSection({ products, variantColors }: Props) {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-12 md:py-20">
      ...
      <ViewItemListTracker listName="coleccion_especial" products={products} />
      <ProductScrollRow products={products} variantColors={variantColors} listName="coleccion_especial" desktopCols={3} />
